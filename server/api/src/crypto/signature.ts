...
import { KeyType, KeyPair as SodiumKeyPair, StateAddress } from "libsodium-wrappers";
...
export class Signature {
    ...
    public sign(sk: Signature.PrivateKey): Uint8Array {
        return crypto_sign_final_create(this.state, sk._bytes());
    }

    public verify(sig: Uint8Array, pk: Signature.PublicKey): boolean {
...
export namespace Signature {
    ...
    export class KeyPair {
        ...
        public static fromSeed(seed: Uint8Array): KeyPair {
            ...
            let kp = crypto_sign_seed_keypair(seed);
            return new KeyPair(kp.keyType, new PrivateKey(kp.privateKey), new PublicKey(kp.publicKey));
        }
