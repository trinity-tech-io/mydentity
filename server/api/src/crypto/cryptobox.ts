...
export class CryptoBox {
    public static MAC_BYTES = 16; // crypto_box_MACBYTES;
...
export class PrivateKey {
    public static BYTES = 32; // crypto_box_SECRETKEYBYTES;
...
export class PublicKey {
    public static BYTES =  32; // crypto_box_PUBLICKEYBYTES;
    private key: Uint8Array;
...
export class KeyPair {
    public static SEED_BYTES= 32; // crypto_box_SEEDBYTES;
...
export class Nonce {
    public static BYTES = 24; // crypto_box_NONCEBYTES;
