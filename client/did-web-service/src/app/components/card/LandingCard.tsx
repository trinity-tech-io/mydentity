...
export const LandingCard: FC = () => {
  return (
    <Card className="card-wrapper max-xl:w-11/12 lg:w-[450px] sm:w-8/12 bg-black noise-bg border-white border-opacity-30 border-2 rounded-3xl relative bg-color">
      <div className="body">
