  ...
  return (
    <>
      <Headline
        ...
        description={
          <>
            Your Web3 identity is <b>secured by cryptographic keys</b>. While
            many Web3 apps ask you to manage these keys yourself, our service
            offers partial key storage, enhancing security. Your keys remain
            protected by your devices or passwords, and{" "}
            <b>we require your consent for any action</b>. To ensure account
            recovery, bind multiple devices and browsers as{" "}
            <b>we cannot do this on your behalf</b>.
          </>
        }
      />
      <div className="py-4">
        ...
        <PortraitCard
          ...
          content={
            <div className="h-full flex items-center max-sm:text-[10px]">
              <span>
                Verify one of your existing email addresses and bind it to your
                account with a password. You can later use your email and
                password to sign in and unlock access to your identity.
              </span>
            </div>
          }
          footer={
            <DarkButton
              ...
              onClick={bindEmail}
            >
              {initialDataFetched ? "BIND EMAIL" : "Loading..."}
            </DarkButton>
          }
        />
        <PortraitCard
          ...
          content={
            <div className="h-full flex items-center max-sm:text-[10px]">
              <span>
                Bind your current browser. This doesn't require to provide any
                email or password, but access to your identity will be lost if
                you don't bind multiple devices as recovery.
              </span>
            </div>
          }
          footer={
            <DarkButton
              ...
              onClick={bindBrowser}
            >
              {initialDataFetched ? "BIND BROWSER" : "Loading..."}
            </DarkButton>
          }
        />
      </Stack>
